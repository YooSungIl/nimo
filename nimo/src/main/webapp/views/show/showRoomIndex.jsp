				...
				<c:forEach items="${bestShowRoom}" var="best">
					<div class="col-md-4 d-flex">
						<div class="product ftco-animate">
							<a href="showRoomDetail.ni?show_name=${best.show_name}"
					...
					<div class="col-md-4 d-flex">
						<div class="product ftco-animate">
							<div class="img d-flex align-items-center justify-content-center"
								style="background-image: url('${recommend.show_img}');">
								<div class="desc">
									<a href="showRoomDetail.ni?show_name=${recommend.show_name}"
								class="img d-flex align-items-center justify-content-center"
			...
			<div class="row">
				<c:forEach items="${gaseongbiShowRoom}" var="gaseongbi">
					<div class="col-md-4 d-flex">
						<div class="product ftco-animate">
							<div class="img d-flex align-items-center justify-content-center"
								style="background-image: url('${gaseongbi.show_img}');">
								<div class="desc">
									<a href="showRoomDetail.ni?show_name=${gaseongbi.show_name}"
								class="img d-flex align-items-center justify-content-center"
								style="background-image: url('${gaseongbi.show_img}');"> </a>
								</div>
							</div>
							<div class="text text-center">
