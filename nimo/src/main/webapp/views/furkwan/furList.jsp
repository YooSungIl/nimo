  		...
  		<div class="row justify-content-center pb-5">
          	<div class="col-md-7 heading-section text-center ftco-animate">
          		<span class="subheading">nimo</span>
           		<h2>의자 골라골라</h2>
           		<button type="button" onclick="location.href='/nimo/fur/nimokwan/furAddForm' ">상품추가</button>
          	</div>
          	
        </div>
        <a href="#" class="btn-custom">인기순 <span class="fa fa-long-arrow-down"></span></a>
        <a href="#" class="btn-custom">가격순 <span class="fa fa-long-arrow-down"></span></a>
        <hr>
						...
						<div class="col-md-3 d-flex">
							<div class="product ftco-animate">
								<div class="img d-flex align-items-center justify-content-center" style="background-image: url(/nimo/resources/furImages/${ image_main });">
									<div class="desc">
										<p class="meta-prod d-flex">
											...
											&nbsp;&nbsp;<a href="/nimo/fur/nimokwan/furDetail?fur_code=${ c.fur_code }" class="d-flex align-items-center justify-content-center"><span class="flaticon-visibility"></span></a>
										</p>
									</div>
								</div>
								<div class="text text-center">
									...
									<p class="mb-0"><span class="price">재고 수량 : ${ c.fur_quantity }개</span></p>
								</div>
							</div>
						</div>
					</c:forEach>
					...
					<ul class="pagination justify-content-center">
						<c:if test="${n ne page.startpage}">
							<li class="page-item"><a class="page-link" href="/nimo/fur/nimokwan/furList?pagenum=${ n -1 }&price=${ price }&search=${ search }">Prev</a></li>
						</c:if>
						...
						<c:forEach var="p" begin="${ page.startpage }" end="${ page.endpage }" step="1">
    						<c:choose>
    							...
    							<c:otherwise>
    								<li class="page-item"><a class="page-link" href="/nimo/fur/nimokwan/furList?pagenum=${ p }">${ p } </a></li>
    							</c:otherwise>
    						</c:choose>
  						</c:forEach>
  						<c:if test="${n ne page.endpage}">
  							<li class="page-item"><a class="page-link" href="/nimo/fur/nimokwan/furList?pagenum=${ n +1 }&price=${ price }&search=${ search }">Next</a></li>
  						</c:if>
