			...
			<div class="row">
				<div class="col-lg-12 mb-5 ftco-animate">
					<form name="show_img" id="form">
						...
						<input type='hidden' name="show_img_input">
						<img id="image_section" class="img-fluid" src="${nimo}/resources/images/du/plus.jpg" />
					</form>
				</div>
					...
					<div class="row detailrow">
						<div class="col-md-6">
							<form name="furn_img1" id="form">
								...
								<input type='hidden' name="furn_img_hidden1">
								<img id="image_furn1" class="img-fluid" src="${nimo}/resources/images/du/plus.jpg" style="width:100;height:100%;" />
							</form>
						</div>
						<div class="col-md-6">
				...
				<div class="col-md-12">
					<div class="row justify-content-center">
						<div class="col-md-4">
							<button type="button"  class="btn btn-primary d-block" id="furnPlus">가구추가</button>
						</div>
						<div class="col-md-4">
		...
		for (i=1; i<=index; i++) {
			...
			function readURL2(input) {
				if (input.files && input.files[0]) {
					...
					reader.onload = function(e) {
						$('#image_furn'+i).attr('src', e.target.result);
					}
					reader.readAsDataURL(input.files[0]);
					...
					$.ajax({
						...
						data : {"fur_image0" : input.files[0].name},
						dataType: "json",
						type:"post",
			...
			$("#image_furn"+i).click(
					function(e) {
						console.log("asdqweasdzxcadqweasd12312312321");
						document.furn_img1.furn_img_hidden1.value = document.getElementById('image_furn'+i).src;
						e.preventDefault();
						$('#furn_img_input'+i).click();
					});
		}
	}
		$('#furnPlus').click(function(e){
			console.log("asd");
