				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="dropdown04">
							<a class="dropdown-item" href="/userShowRoom">인덱스</a> <a
								class="dropdown-item" href="/userShowRoom/livingShowRoomList.ni">
								거실 상품 리스트</a> <a class="dropdown-item" href="#">거실 상세</a> <a
				...
				<c:forEach items="${showRoomList}" var="showRoomList">
					<div class="col-lg-12 d-flex align-items-stretch ftco-animate">
						<div class="blog-entry d-md-flex">
							<a href="adShowRoomDetail.ni?show_name=${showRoomList.show_name}"
								class="block-20 img"
								style="background-image: url('${showRoomList.show_img}');">
							</a>
							<div class="text p-4 bg-light">
								...
								<input type="hidden" name="furns"
									value="${showRoomList.show_furs_code}">
								<p>${showRoomList.show_detail}</p>

								<p>
									<a
										href="adShowRoomDetail.ni?show_name=${showRoomList.show_name}"
										class="btn btn-primary py-3 px-5 mr-2">수정</a> <a
										href="adShowRoomDelete.ni?show_name=${showRoomList.show_name}"
